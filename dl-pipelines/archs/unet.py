...
class StandardUpCrop(torch.nn.Module):
    def __init__(self, in_channels, out_channels, tanh=False):
        super(StandardUpCrop, self).__init__()
...
class StandardUpPad(torch.nn.Module):
    def __init__(self, in_channels, out_channels, tanh=False):
        super(StandardUpPad, self).__init__()
        self.up = torch.nn.ConvTranspose2d(in_channels, in_channels // 2,
                                           kernel_size=2, stride=2)
        self.conv = DoubleConv(in_channels, out_channels, out_channels)
    
    def forward(self, x1, x2):
        # pad self.up(x1) to match x2 dims
        x1 = self.up(x1)
...
class PadStandardUpCrop(torch.nn.Module):
    def __init__(self, in_channels, out_channels):
        super(PadStandardUpCrop, self).__init__()
        self.up = torch.nn.ConvTranspose2d(in_channels, in_channels // 2,
                                           kernel_size=2, stride=2)
...
class PadStandardUpPad(torch.nn.Module):
    def __init__(self, in_channels, out_channels):
        super(PadStandardUpPad, self).__init__()
        self.up = torch.nn.ConvTranspose2d(in_channels, in_channels // 2,
                                           kernel_size=2, stride=2)
        self.conv = PadDoubleConv(in_channels, out_channels, out_channels)
...
class PaddedUNet(torch.nn.Module):
    def __init__(self, in_ch=3, num_classes=1, init_weights=True, pool='max',
                 upsample_pad=False):
        ...
        PadStandardUp = PadStandardUpPad if upsample_pad \
                        else PadStandardUpCrop
...
class UNet(torch.nn.Module):
    def __init__(self, in_ch=3, num_classes=1, init_weights=True, pool='max',
        ...
        StandardUp = StandardUpPad if upsample_pad \
                     else StandardUpCrop
